 ...
 */
package com.qz.lifehelper.ui.view;
...
//		setSelection(mTotalItemCount - 1); // scroll to bottom
    ...
    public void setOnItemClickListener(final OnItemClickListener listener) {
        ...
        OnItemClickListener wrapperListener = new OnItemClickListener() {
            @Override
    ...
    public void setOnItemLongClickListener(final OnItemLongClickListener listener) {
        ...
        OnItemLongClickListener wrapperListener = new OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    return listener.onItemLongClick(parent, view, position, id);
                } else if (position > 0) {
                    return listener.onItemLongClick(parent, view, position - 1, id);
                }
                return false;
            }
        };
